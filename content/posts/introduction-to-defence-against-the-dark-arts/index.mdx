...
Uns científicos do  MIT (Instituto de Tecnoloxía de  Massachusetts) encabezados por *Markus Buehler*, están a traballar nun proxecto para desenvolver novas proteínas a partir de modelos con IA e redes
neuronais. O proxecto baséase en converter secuencias
