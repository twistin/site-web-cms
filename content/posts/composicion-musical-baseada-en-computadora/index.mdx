...
A idea de base que utilizaron  Rumelhart , é que os programas de computador tradicionais funcionan de maneira moi distinta aos cerebros humanos, e esa podería ser a razón pola cal os programas de computadora foran (ata ese momento) tan deficientes para facer cousas que os cerebros atopan fáciles (como recoñecer obxectos en imaxes). Os autores afirmaron que o enfoque  PDP estaba "máis preto que outros marcos" de como funciona o cerebro e, por tanto, podería manexar mellor este tipo de tarefas.